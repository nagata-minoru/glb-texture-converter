 ...
 */
const getImageMetadata = async (img: Uint8Array): Promise<{ width: number, height: number }> => {
 ...
 */
const processFile = async (filePath: string, scaleRatio: number): Promise<Uint8Array> => {
 ...
 */
const saveFile = async (filePath: string, data: Uint8Array): Promise<void> => {
  try {
